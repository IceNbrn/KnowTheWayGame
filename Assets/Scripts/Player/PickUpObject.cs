...
namespace Player
{
    public class PickUpObject : MonoBehaviour
    {
        ...
        {
            Debug.Log($"Pressing");
            if (Physics.Raycast(m_CameraPosition.position, m_CameraPosition.forward, out m_Hit, 2f) && m_Hit.transform.gameObject.CompareTag("PickUp") && m_Hit.transform.GetComponent<Rigidbody>())
            {
